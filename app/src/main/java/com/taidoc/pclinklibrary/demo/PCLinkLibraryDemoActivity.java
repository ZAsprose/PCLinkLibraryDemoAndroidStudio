...
public class PCLinkLibraryDemoActivity extends FragmentActivity {
            ...
            if (mSelectedMeter.getSelectedItem() != null) {
                ...
                if (!"".equals(deviceMac)) {
                    ...
                    if (mKNVMode) {
                        ...
                        bundle.putString("thresholdstr", thresholdstr);
                        Intent intent = new Intent(PCLinkLibraryDemoActivity.this,
    ...
    //hello world without sensor
    public Button.OnClickListener mHelloWorldOnClickListener;

    {
        mHelloWorldOnClickListener = new Button.OnClickListener() {

            @Override
            public void onClick(View v) {

                Bundle bundle = new Bundle();
                bundle.putString("weight", "110");
                Intent intent = new Intent(PCLinkLibraryDemoActivity.this,
                ...
                //finish();
                /*GuiUtils.goToSpecifiedActivity(PCLinkLibraryDemoActivity.this,
                    NoSensorMySQLHW.class, bundle);
                GuiUtils.goToSpecifiedActivity(PCLinkLibraryDemoActivity.this,
                        NoSensorMySQLHW.class,bundle)*/
                /*Intent intent = new Intent();
                intent.setClass(PCLinkLibraryDemoActivity.this, NoSensorMySQLHW.class);
                intent.putExtra("weight", "110");
                meterDialog.startActivity();*/
                //finish();
                //PCLinkLibraryCommuTestActivityForKNV.class);
            }
        };
    ...
    private void findViews() {
        ...
        //hello world without sensor
        mHelloWorld = (Button) findViewById(R.id.ButHW);
    }
    ...
    private void setListener() {
        ...
        //hello world without sensor
        mHelloWorld.setOnClickListener(mHelloWorldOnClickListener);
    }
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                        	...
                        	if (adapterCount > 0) {
                                ...
                                Log.i("mSelectedMeter", String.valueOf(mSelectedMeter.getChildAt(0)));
                            } else {
