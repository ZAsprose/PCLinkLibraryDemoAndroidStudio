...
public class PCLinkLibraryCommuTestActivity extends ListActivity {
    ...
    public NoSensorMySQLHW nosql;



    /*public void setListeners(final int sysValue) {
        hwbutton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                Bundle bundle = new Bundle();
                bundle.putInt("weight", sysValue);
                Intent intent = new Intent(PCLinkLibraryCommuTestActivity.this,
                        NoSensorMySQLHW.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        thresholdstr = bundle.getString("thresholdstr");
        Log.i("Intent", thresholdstr);*/
                
        setAdapter();
        //setListeners(sysValue);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (hasOnClinkListener) {
                        	...
                        	if (PCLinkLibraryDemoConstant.PL2303_TRANSFER_TYPE.equals(mBtTransferType)) {
                                ...
                                Log.i("sysValue builder.setPositiveButton", String.valueOf(sysValue));
                                GuiUtils.goToPCLinkLibraryHomeActivity(PCLinkLibraryCommuTestActivity.this);
                            }
                        } /* end of if */
                    };
                    ...
                    try {
                        ...
                        switch (clickItem) {
                            ...
                            case 3:
                                ...
                                // Views
                                //Button hwbutton = (Button) findViewById(R.id.hwBut);
                                //setListeners(sysValue);
                                ...
                                if (record instanceof BloodGlucoseRecord) {
                                    ...
                                    Log.i("BloodPressureRecord","start");
                                    // Convert value
                                    sysValue = ((BloodPressureRecord) record)
                                            .getSystolicValue();
                                    Log.i("BloodPressureRecord","get sysvalue");
                                    ...
                                    Log.i("sysValue Input: ", String.valueOf(sysValue));
                                    String measurementDate = formatterDate
                                    ...
                                    Log.i("BloodPressureRecord", "value done");
                                    ...
                                    if (pcon != null) {
                                        ...
                                        try {
                                            ...
                                            int result = stmt.executeUpdate("insert into zzjhw " +
                                                    "VALUES(null," + thresholdint + "," + weightint + ",'" + hwdb + "')");
                                        ...
                                        new AlertDialog.Builder(PCLinkLibraryCommuTestActivity.this)
                                                .setTitle("Success")
                                                .setMessage("if Systoric > Threshold, upper shows \"hello\"\nelse show \"world\"\n\n"
